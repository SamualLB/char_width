struct Char
  ...
  def width : Int32
    return 0 if ord == 0
    return -1 if ord < 32 || (ord >= 0x7f && ord < 0xa0)
  ...
  def width_cjk : Int32
    UNICODE_INTERVAL_CHARS.each { |range| return 2 if range.includes?(ord) }
    width
  end
end
